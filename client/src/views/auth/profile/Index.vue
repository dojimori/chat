<template>
  <main
    class="flex flex-col gap-0 border border-gray-400 w-full sm:w-2xl md:w-3xl lg:w-7xl min-h-[844px]"
  >
    ...
    <div class="flex-1 flex flex-col lg:flex-row justify-center">
      ...
      <div class="flex-1 bg-white">
        <div
          class="p-2 flex-1 flex flex-col gap-3 min-h-[400px] max-h-[400px] lg:min-h-[660px] lg:max-h-[660px]"
        >
          <div
            class="flex flex-col gap-4 bg-gray-100 border border-gray-300 rounded-sm p-4"
          >
            <textarea
              name=""
              id=""
            ...
            <div class="flex">
              <button
                class="post-btn text-white py-1.5 px-6 border border-gray-400 cursor-pointer"
              >
                post
              </button>
            </div>
